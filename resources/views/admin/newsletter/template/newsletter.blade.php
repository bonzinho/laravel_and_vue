                        ...
                        <table width="560" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                            ...
                            <tr>
                                <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #303030;text-align:center;" st-content="viewonline">
                                    Se não conseguir ver este email, veja <a href="" target="_blank" style="text-decoration: none; color: #7a6e67">online</a>
                                </td>
                                <!-- Spacing -->
                            </tr>
                            <tr>
                                            ...
                                            <td width="174" height="60" align="left">
                                                <div class="imgpop">
                                                    <a target="_blank" href="#">
                                                        <img src="{{asset("storage/newsletter/feup-logo.png")}}" alt="" border="0" width="174" height="21" style="display:block; border:none; outline:none; text-decoration:none;">
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
                        ...
                        <table width="560" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                            ...
                            <tr>
                                ...
                                <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                        <a target="_blank" href="#"><img width="560" border="0" height="200" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="{{asset("storage/newsletter/banner_exemplo.png")}}" class="banner"></a>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                                    ...
                                    <table width="520" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td width="520" align="center" class="devicewidthinner">
                                                <img src="{{asset("storage/noticias/images/{$noticia->photo}")}}" alt="" border="0" width="520" height="200" style="display:block; border:none; outline:none; text-decoration:none;" class="blog">
                                            </td>
                                        </tr>
                                        <!-- /image -->
                                        <!-- Spacing -->
                                        <tr>
                                            <a href="{{$noticia->link}}" target="_blank"><td width="100%" height="15" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td></a>
                                        </tr>
                                        <!-- /Spacing -->
                                        <tr>
                                        ...
                                        <!-- content -->
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; align:left; color: #7a6e67; text-align:left; line-height: 24px;">
                                                {{$noticia->description}}
                                                <p>
                                    ...
                                    <table width="60" height="40" align="right" vaalign="middle"  border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td width="22" height="22" align="left">
                                                <div class="imgpop">
                                                    <a target="_blank" href="https://www.facebook.com/paginafeup">
                                            ...
                                            <td width="22" height="22" align="right">
                                                <div class="imgpop">
                                                    <a target="_blank" href="https://twitter.com/feup_porto">
